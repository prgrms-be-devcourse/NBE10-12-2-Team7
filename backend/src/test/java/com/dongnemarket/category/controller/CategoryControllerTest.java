...
class CategoryControllerTest {
	...
	void getsProductsByCategoryWithoutAuthentication() throws Exception {
		...
		Product hiddenProduct = Product.create(member, targetCategory, "숨김 상품", "숨김 상품 설명", BigDecimal.valueOf(40000), findRegion("1144012400"));
		hiddenProduct.hide();
		productRepository.save(hiddenProduct);
		Product deletedProduct = Product.create(member, targetCategory, "삭제 상품", "삭제 상품 설명", BigDecimal.valueOf(50000), findRegion("1117013000"));
