 ...
 */
@Component
public class AdminDashboardTools {

    private final AdminDashboardService adminDashboardService;

    public AdminDashboardTools(AdminDashboardService adminDashboardService) {
        this.adminDashboardService = adminDashboardService;
    }

    @Tool(description = "관리 대시보드 집계를 조회한다. 전체 회원 수, 전체 상품 수, 전체 신고 수, "
