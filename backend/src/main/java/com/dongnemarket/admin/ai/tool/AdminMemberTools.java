 ...
 */
@Component
public class AdminMemberTools {

    private final AdminMemberService adminMemberService;

    public AdminMemberTools(AdminMemberService adminMemberService) {
        this.adminMemberService = adminMemberService;
    }

    @Tool(description = "전체 회원 목록을 조회한다. 상태(ACTIVE/SUSPENDED/DELETED)와 무관하게 모든 회원이 반환된다. "
    ...
    public AdminMemberResponse getMember(
            @ToolParam(description = "조회할 회원의 ID (양의 정수)") Long memberId) {
