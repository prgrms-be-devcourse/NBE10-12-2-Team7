 ...
 */
@Component
public class AdminProductTools {

    private final AdminProductService adminProductService;

    public AdminProductTools(AdminProductService adminProductService) {
        this.adminProductService = adminProductService;
    }

    @Tool(description = "전체 상품 목록을 조회한다. 숨김/삭제 여부와 무관하게 모든 상품이 반환된다. "
    ...
    public AdminProductResponse getProduct(
            @ToolParam(description = "조회할 상품의 ID (양의 정수)") Long productId) {
