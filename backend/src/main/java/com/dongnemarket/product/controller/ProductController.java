...
public class ProductController {
	...
	public ApiResponse<ProductPageResponse> getProducts(
		...
		return ApiResponse.success(productService.getProducts(regionId, cursor, size));
	}
	...
	public ApiResponse<List<ProductSummaryResponse>> searchProducts(
			...
			@RequestParam(required = false) Long regionId) {
		ProductSearchRequest request = new ProductSearchRequest(keyword, categoryId, minPrice, maxPrice, tradeStatus, regionId);
